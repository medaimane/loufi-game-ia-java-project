...
public class EngineGame extends JPanel implements Runnable, Serializable {
    ...
    public EngineGame() {
        ...
        this.playerPosition = new Dimension(0,0);
    ...
    public EngineGame(String playerImage, Dimension playerPosition, Integer mazeIndex, int width, int height) {
    ...
    public EngineGame(String playerImage, Dimension playerPosition,Integer algoIndex, Integer bonnusNum, Integer botsNum, Integer mazeIndex, int width, int height) {
        this.theMap = new Maze(mazeIndex, width, height);
    ...
    private void play() {
        player = new Player(this.playerPosition, this.playerImage);
            ...
            if (0 != this.algoIndex) {
                switch (this.algoIndex) {
                    case 1:
                        ...
                        path = null;
                        path = ((DepthFirstSearchEngine) algoritme).getSearchPath(bots[i], bots[i].getBonus());
                        if (path != null) {
                            bots[i].setPath(path);
                        }
                        break;
                    ...
                    case 3:
                        ...
                        path = null;
                        path = ((AStarSearchEngine) algoritme).getSearchPath(bots[i], bots[i].getBonus());
                        if (path != null) {
                            bots[i].setPath(path);
                        }
                        break;
                ...
                switch (KeyCode) {
                    case KeyEvent.VK_DOWN:
                        if (PlayGameFrame.startPauseButton.getText().equals("Break")) {
                            if (Move(player.getDimension(), "BOTTOM") == 1
                                    && Move(new Dimension(player.getDimension().width, player.getDimension().height + 1), "TOP") == 1) {
                                        ...
                                        if (0 != this.algoIndex) {
                                            switch (this.algoIndex) {
                                                case 1:
                                                    ...
                                                    path = null;
                                                    path = ((DepthFirstSearchEngine) algoritme).getSearchPath(bot, bot.getBonus());
                                                    if (path != null) {
                                                        bot2.setPath(path);
                                                    } else {
                                                ...
                                                case 3:
                                                    path = null;
                                                    path = ((AStarSearchEngine) algoritme).getSearchPath(bot, bot.getBonus());
                                                    if (path != null) {
                                                        bot2.setPath(path);
                                                    } else {
